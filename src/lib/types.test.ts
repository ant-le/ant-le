...
import type { BlogPost, RunningPB, FriendsData, RunningTraining, BlogCategory, RunningDistance } from './types';
...
describe('Type Definitions', () => {
	...
	describe('RunningPB interface', () => {
		it('should have all required properties', () => {
			...
			expect(['5k', '10k', 'Half Marathon', 'Marathon']).toContain(runningPB.distance);
