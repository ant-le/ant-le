...
<div
    ...
    artistic:rounded-2xl artistic:border artistic:border-neutral-200 
    artistic:bg-bg-primary artistic:p-8 artistic:shadow-md
    {className}"
>
    <div
            ...
            >
                <div class="flex items-center gap-4">
                    <svg
                        ...
                        viewBox="0 0 24 24"
                        class="h-6 w-6 sm:h-8 sm:w-8 flex-shrink-0 fill-text-tertiary artistic:fill-secondary"
                    >
                        <path
                ...
                <div class="text-right font-semibold text-accent">
                    {pb.time}
                </div>
            </div>
        {/each}
